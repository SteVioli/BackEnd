...
@NamedQuery(name = "trovaPrestitoScaduto" , query = "SELECT p FROM Prestito p WHERE p.restituzioneEffettiva = null AND (TO_DATE(p.restituzionePrevista,'dd-MM-yyyy')< TO_DATE(:data,'dd-MM-yyyy'))" )
...
public class Prestito {
	...
	public Prestito(Utente utente, Catalogo elementoPrestato, String inizioPrestito, String restituzionePrevista,
			String restituzioneEffettiva) {
		super();
		this.utente = utente;
