...
public class TestController {
	...
	@PostMapping("/creatablet")
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<DispositivoAziendale> creaTablet(@RequestBody Tablet t){
		return new ResponseEntity<DispositivoAziendale>(dispoService.saveDispositivo(t),HttpStatus.OK);
	}
	
	@PostMapping("/creasmartphone")
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<DispositivoAziendale> creaSmartphone(@RequestBody Smartphone s){
		return new ResponseEntity<DispositivoAziendale>(dispoService.saveDispositivo(s),HttpStatus.OK);
	}
	
	@PostMapping("/crealaptop")
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<DispositivoAziendale> creaLaptop(@RequestBody Laptop l){
		return new ResponseEntity<DispositivoAziendale>(dispoService.saveDispositivo(l),HttpStatus.OK);
	}
